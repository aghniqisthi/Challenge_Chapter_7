...
import com.example.challengechapter7.marcelle.adapter.ProductAdapter
import com.example.challengechapter7.marcelle.viewmodel.ViewModelProduct
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnProfile.setOnClickListener {
            val pindah = Intent(this, com.example.challengechapter7.marcelle.view.ProfileActivity::class.java)
